...
var shellApi = {
	...
	,getFreePort:function(app, port) {
		...
		if (typeof myApp.params['launchChromium'] == 'undefined') myApp.params['launchChromium'] = true;
		if (typeof myApp.params['exitOnChromiumClose'] == 'undefined') myApp.params['exitOnChromiumClose'] = true;
